...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
		...
		("The remote partner has closed the session.", "Attālais partneris ir slēdzis sesiju."),        
        ...
        ("install_cert_tip", "Instalēt HopToDesk sertifikātu"),
        ("confirm_install_cert_tip", "Šis ir HopToDesk testēšanas sertifikāts, kuram var uzticēties. Sertifikāts tiks izmantots, lai uzticētos un vajadzības gadījumā instalētu HopToDesk draiverus."),
        ...
        ("2FA QR code", "2FA QR kods"),
		("Enable Wake On LAN", "Iespējot Wake On LAN"),
		("Enable 2FA", "2FA aktivieren"),
        ("Enable 2FA Auto Accept", "Iespējot 2FA automātisko pieņemšanu"),
        ("Scan this QR code with a camera on a secondary device such as a phone to set it up as your 2FA authenticator.", "Skenējiet šo QR kodu ar sekundārās ierīces, piemēram, tālruņa, kameru, lai iestatītu to kā 2FA autentifikatoru."),
