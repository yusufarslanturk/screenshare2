...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_cert_tip", "تثبيت شهادة HopToDesk"),
        ("confirm_install_cert_tip", "هذه شهادة HopToDesk الاختبارية, يمكنك الوثوق بها. هذه الشهادة ستستخدم للوثوق وتثبيت تعاريف HopToDesk عند الحاجة."),
        ...
        ("Enable 2FA Auto Accept", "تمكين القبول التلقائي 2FA"),
        ("2FA QR code", "2FA رمز الاستجابة السريعة"),
        ("Scan this QR code with a camera on a secondary device such as a phone to set it up as your 2FA authenticator.", "امسح رمز الاستجابة السريعة هذا ضوئيًا باستخدام كاميرا على جهاز ثانوي مثل الهاتف لإعداده باعتباره أداة مصادقة المصادقة الثنائية (2FA)."),
