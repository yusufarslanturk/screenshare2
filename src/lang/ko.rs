...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
		...
		("Enable 2FA", "2FA 활성화"),
        ("Enable 2FA Auto Accept", "2FA 자동 수락 활성화"),		
        ("2FA QR code", "2FA QR 코드"),
        ("Scan this QR code with a camera on a secondary device such as a phone to set it up as your 2FA authenticator.", "휴대폰과 같은 보조 장치의 카메라로 이 QR 코드를 스캔하여 2FA 인증자로 설정하십시오."),
