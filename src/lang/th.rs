...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Wait", ""),
        ("Elevation Error", ""),
        ("Ask the remote user for authentication", "ขอการรับรองความถูกต้องจากผู้ใช้ระยะไกล"),
        ("Choose this if the remote account is administrator", "เลือกตัวเลือกนี้หากบัญชีระยะไกลเป็นผู้ดูแลระบบ"),
        ("Transmit the username and password of administrator", "ส่งชื่อผู้ใช้และรหัสผ่านของผู้ดูแลระบบ"),
        ("still_click_uac_tip", ""),
        ("Request Elevation", "ขอระดับความสูง"),
        ("wait_accept_uac_tip", ""),
        ("Elevate successfully", "ยกระดับได้สำเร็จ"),
        ("uppercase", ""),
        ("lowercase", ""),
        ("digit", ""),
        ("special character", ""),
        ...
        ("FPS", ""),
        ("Auto", ""),
		("Other Default Options", "ตัวเลือกเริ่มต้นอื่น ๆ"),
		("Voice call", "สายโทรศัพท์เสียง"),
		("Text chat", "สนทนาข้อความ"),
		("Stop voice call", "หยุดสายโทรศัพท์เสียง"),
		("relay_hint_tip", "คำแนะนำ Relay"),
		("Reconnect", "เชื่อมต่อใหม่"),
		("Codec", "รหัสแบบ"),
		("Resolution", "ความละเอียด"),
		("No transfers in progress", "ไม่มีการโอนไฟล์กำลังดำเนินการ"),
		("Set one-time password length", "ตั้งความยาวรหัสผ่านชั่วคราว"),
		("idd_driver_tip", ""),
        ...
        ("scam_text1", "ถ้าคุณกำลังคุยโทรศัพท์กับคนที่คุณไม่รู้จักและไม่ไว้ใจ และคนๆนั้นกำลังขอให้คุณเปิดใช้งาน HopToDesk อย่าทำตามและรีบวางสายในทันที"),
        ...
        ("Enable 2FA Auto Accept", "เปิดใช้งาน 2FA Auto-Accept"),		
