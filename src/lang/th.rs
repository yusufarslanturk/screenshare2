...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_cert_tip", "ติดตั้งใบรับรองของ HopToDesk"),
        ("confirm_install_cert_tip", "นี่คือใบรับของทดสอบของ HopToDesk ซึ่งสามารถเชื่อถือได้ ใบรับรองนี้จะถูกใช้ในการติดตั้ง Driver ของ HopToDesk เมื่อจำเป็น"),
