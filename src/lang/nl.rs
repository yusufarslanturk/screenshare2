...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Enable 2FA Auto Accept", "Schakel 2FA Automatisch Accepteren in"),				
        ("Scan this QR code with a camera on a secondary device such as a phone to set it up as your 2FA authenticator.", "Scan deze QR-code met een camera op een secundair apparaat zoals een telefoon om deze in te stellen als uw 2FA-authenticator."),
