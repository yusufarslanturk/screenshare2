...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Scan this QR code with a camera on a secondary device such as a phone to set it up as your 2FA authenticator.", "Skenirajte ovaj QR kod sa kamerom na sekundarnom uređaju kao što je telefon da ga postavite kao vaš 2FA autentifikator."),
