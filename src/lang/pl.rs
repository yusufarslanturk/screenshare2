...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_cert_tip", "Instalacja certyfikatu HopToDesk"),
        ("confirm_install_cert_tip", "To jest certyfikat testowy HopToDesk, któremu można zaufać. Certyfikat jest używany do zaufania i instalowania sterowników HopToDesk w razie potrzeby."),
