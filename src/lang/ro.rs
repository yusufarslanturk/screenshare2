...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_cert_tip", "Instalează certificatul HopToDesk"),
        ...
        ("Enable 2FA Auto Accept", "Activați 2FA Auto Accept"),		
		("Enable Wake On LAN", "Activați Wake On LAN"),
		("2FA QR code", "Cod QR 2FA"),		
        ("Scan this QR code with a camera on a secondary device such as a phone to set it up as your 2FA authenticator.", "Scanați acest cod QR cu o cameră pe un dispozitiv secundar, cum ar fi un telefon, pentru a-l configura ca autentificator 2FA."),
