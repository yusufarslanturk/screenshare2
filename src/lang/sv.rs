...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Enable 2FA Auto Accept", "Aktivera 2FA Auto-Accept"),						
		("Enable Wake On LAN", "Aktivera Wake On LAN"),
		("2FA QR code", "2FA QR-kod"),		
        ("Scan this QR code with a camera on a secondary device such as a phone to set it up as your 2FA authenticator.", "Skanna den här QR-koden med en kamera på en sekundär enhet som en telefon för att ställa in den som din 2FA-autentisering."),
