...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("confirm_idd_driver_tip", "L'option d'installation du pilote d'affichage virtuel est cochée. Notez qu'un certificat de test sera installé pour faire confiance au pilote d'affichage virtuel. Ce certificat de test ne sera utilisé que pour faire confiance aux pilotes HopToDesk."),
        ...
        ("Enable 2FA Auto Accept", "Activer l'acceptation automatique 2FA"),		
        ("2FA QR code", "Code QR 2FA"),
        ("Scan this QR code with a camera on a secondary device such as a phone to set it up as your 2FA authenticator.", "Scannez ce code QR avec une caméra sur un appareil secondaire tel qu'un téléphone pour le configurer comme votre authentificateur 2FA."),
