...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_cert_tip", "HopToDesk-Zertifikat installieren"),
        ...
        ("Enable 2FA Auto Accept", "Aktivieren Sie die automatische 2FA-Akzeptanz"),
        ("Scan this QR code with a camera on a secondary device such as a phone to set it up as your 2FA authenticator.", "Scannen Sie diesen QR-Code mit einer Kamera auf einem sekundären Gerät wie einem Telefon, um es als Ihren 2FA-Authentifikator einzurichten."),
