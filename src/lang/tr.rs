...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_cert_tip", "HopToDesk sertifikasını yükleyin"),
        ("confirm_install_cert_tip", "Bu, güvenilir olabilecek bir HopToDesk test sertifikasıdır. Sertifika, gerekli olduğunda HopToDesk sürücülerini güvenilir ve yüklemek üzere kullanacaktır."),
