...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
		...
		("Enable 2FA", "启用2FA"),
        ("Enable 2FA Auto Accept", "启用 2FA 自动接受"),		
		("2FA QR code", "2FA二维码"),
        ("Scan this QR code with a camera on a secondary device such as a phone to set it up as your 2FA authenticator.", "使用手机等辅助设备上的相机扫描此二维码，将其设置为您的 2FA 身份验证器。"),
