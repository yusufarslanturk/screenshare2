...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Enable 2FA Auto Accept", "2FA 自動承認を有効にする"),
        ("Scan this QR code with a camera on a secondary device such as a phone to set it up as your 2FA authenticator.", "この QR コードを電話などのセカンダリ デバイスのカメラでスキャンして、2FA 認証システムとして設定します。"),
