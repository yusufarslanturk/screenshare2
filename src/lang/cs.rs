...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_cert_tip", "Instalace certifikátu HopToDesk"),
        ("confirm_install_cert_tip", "Jedná se o testovací certifikát HopToDesk, kterému lze důvěřovat. Certifikát bude v případě potřeby použit k důvěryhodnosti a instalaci ovladačů HopToDesk."),
        ...
        ("2FA QR code", "2FA QR kód"),
        ("Enable 2FA", "Povolit 2FA"),
        ("Enable 2FA Auto Accept", "Povolit 2FA Auto-Accept"),		
        ("Scan this QR code with a camera on a secondary device such as a phone to set it up as your 2FA authenticator.", "Naskenujte tento QR kód pomocí fotoaparátu na sekundárním zařízení, jako je telefon, a nastavte jej jako svůj 2FA autentifikátor."),
