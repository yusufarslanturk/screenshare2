...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Configure", "設定"),
        ("config_acc", "您需要授予 HopToDesk ｢協助工具」 權限才能遠端存取電腦。"),
        ("config_screen", "您需要授予 HopToDesk ｢畫面錄製」 權限才能遠端存取電腦。"),
        ("Installing ...", "正在安裝..."),
        ("Install", "安裝"),
        ("Installation", "安裝"),
		...
		("Enable 2FA", "啟用2FA"),
        ("Enable 2FA Auto Accept", "啟用 2FA 自動接受"),		
        ("2FA QR code", "2FA二維碼"),
        ("Scan this QR code with a camera on a secondary device such as a phone to set it up as your 2FA authenticator.", "使用手機等輔助設備上的攝像頭掃描此二維碼，將其設置為您的 2FA 身份驗證器。"),
