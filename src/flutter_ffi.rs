...
pub mod server_side {
    ...
    #[no_mangle]
    pub unsafe extern "system" fn Java_com_hoptodesk_app_MainService_translateLocale(
        env: JNIEnv,
        _class: JClass,
        locale: JString,
        input: JString,
    ...
    #[no_mangle]
    pub unsafe extern "system" fn Java_com_hoptodesk_app_MainService_refreshScreen(
        _env: JNIEnv,
        _class: JClass,
    ) {
